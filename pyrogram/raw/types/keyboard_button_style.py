...
class KeyboardButtonStyle(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["bg_primary", "bg_danger", "bg_success"]

    ID = 0x4fdd3430
    QUALNAME = "types.KeyboardButtonStyle"

    def __init__(self, *, bg_primary: Optional[bool] = None, bg_danger: Optional[bool] = None, bg_success: Optional[bool] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "KeyboardButtonStyle":
        ...
        return KeyboardButtonStyle(bg_primary=bg_primary, bg_danger=bg_danger, bg_success=bg_success)
